...
public class PreExamDAO {
    private static final String URL = "jdbc:~/h2db/db_prac;Mode=PostgreSQL;AUTO_SERVER=TRUE";
    private static final String USER_NAME = "b2221150";
    private static final String USER_PASS = "b2221150";
